...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::rename_source_set,
            commands::list_authored_layout_presets,
            commands::save_authored_layout_preset,
            commands::delete_authored_layout_preset,
            commands::create_trim_sheet_document,
            commands::create_source_frame_document,
            commands::create_stage_15_16_feedback_sample,
            commands::regenerate_source_frame_partition,
            commands::apply_document_command,
            commands::apply_feedback_workbench_command,
            commands::stage_15_20_debug_payload,
            ...
            commands::preview_stage_15_16_feedback,
            commands::export_stage_14_material_maps,

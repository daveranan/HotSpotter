...
pub use document::{
    ...
    ChannelBitDepth, ChannelRenderPolicy, ContentReference, DocumentHash, EdgeDetailIntentV1,
    EdgeDetailValidationReason, EdgeEligibility, EdgeWearIntent, FitAxis,
    ...
    Projection, QuarterTurn, EDGE_DETAIL_INTENT_SCHEMA_VERSION, LEGACY_EDGE_WEAR_METERS_PER_PIXEL,
    REGION_BEHAVIOR_VERSION, RadialMappingSettings,

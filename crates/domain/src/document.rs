...
impl Default for EdgeDetailIntentV1 {
    fn default() -> Self {
        Self {
            ...
            intensity: 0.72,
            edge_width_m: 0.006,
            bevel_radius_m: 0.004,
            edge_softness: 0.20,
            breakup_amount: 0.78,
            breakup_scale_m: 0.012,
            micro_detail_amount: 0.35,
            micro_detail_scale_m: 0.001_5,
            seed: 201_516,
            source_height_influence: 0.55,
            source_luminance_influence: 0.16,
            height_amplitude_m: -0.000_8,
            normal_detail_strength: 1.10,
            hue_shift_degrees: 0.0,
            saturation_multiplier: 0.96,
